...
def main(argv=None):
    ...
    try:
        parser = argparse.ArgumentParser(description='UnivBot, a IRC Bot',
        ...
        if not os.path.isfile(configpath):
            print("Bienvenido a UnivBot!\nParece que no puedo encontrar el archivo de configuración, así que vamos a generarlo!\n")
